...
namespace Utility   
{
    ...
    public static class BusinessRules
    {
        ...
        /// <summary>
        /// Outputs the string of the corresponding error code.
        /// </summary>
        /// <param name="errorCode">int code indicating error type</param>
        /// <returns>The string of the error message.</returns>
        public static string RegisterError(int errorCode)
        {
            ...
            {
                return "An error has occured while updating the registration.";
            }
            else
            {
